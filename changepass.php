	...
	<div class="dashboard" style="background-color:#fff;">
		...
		<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:415px; margin-bottom:30px;background-color:#f3f3f8;color:#141313;">
			...
			<?php 
							...
							$sql= "SELECT * FROM users WHERE email= '" . $_SESSION["email"]."' AND password= '" . $_POST["password"]."'";
							...
							if($row>0){
								...
								$sql1="UPDATE users SET password='" . $_POST["newpassword"]  ."' WHERE email='" .$_SESSION["email"] ."'";
